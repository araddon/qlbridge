...
func LoadTestDataOnce() {
	loadData.Do(func() {
		...
		mockcsv.CreateCsvTable(mockcsv.SchemaName, "users", `user_id,email,interests,reg_date,referral_count,json_data
...
hT2impsabc345c,"not_an_email_2",,"2009-12-11T19:53:31.547Z",12,"{""name"":""bob""}"`)
		...
		mockcsv.CreateCsvTable(mockcsv.SchemaName, "orders", `order_id,user_id,item_id,price,order_date,item_count
